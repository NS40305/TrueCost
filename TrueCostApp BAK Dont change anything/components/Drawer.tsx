                ...
                <div className="flex-1 overflow-y-auto py-3 px-3 space-y-1">
                    ...
                    <div className="mt-4 pt-4 border-t border-border">
                        ...
                        >
                            ...
                            <div className={`relative w-10 h-5 rounded-full transition-colors ${darkMode ? 'bg-accent' : 'bg-border'}`}>
                    ...
                    <div className="pt-2">
                        <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-muted">
                            ...
                            <select
                                ...
                                className="flex-1 px-3 py-2 rounded-xl bg-surface-hover border border-border text-sm font-medium text-foreground focus:outline-none focus:ring-2 focus:ring-accent/40 focus:border-accent transition-all appearance-none cursor-pointer"
                            >
                                {LANGUAGES.map((lang) => (
                ...
                <div className="p-3 border-t border-border space-y-2 shrink-0">
                    <div className="flex gap-2">
                        <button
                            ...
                            className="flex-1 px-3 py-2 rounded-xl text-xs font-semibold bg-surface-hover hover:bg-accent/15 hover:text-accent transition-colors"
                        >
                            {T('export')}
                        </button>
                        <button
                    ...
                    <button
                        onClick={handleReset}
                        className="w-full px-3 py-2 rounded-xl text-xs font-semibold text-red-400 bg-red-500/10 hover:bg-red-500/20 transition-colors mt-2"
                    >
                        {T('resetAllData')}
                    </button>
                    <button
                        onClick={handleDemo}
                        className="w-full px-3 py-2 rounded-xl text-xs font-semibold text-amber-500 bg-amber-500/10 hover:bg-amber-500/20 transition-colors mt-2"
                    >
                        {T('demoMode')}
                    </button>
